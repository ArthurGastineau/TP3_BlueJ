...
public class PorteET extends Circuit
{
   ...
   /**
     * Constructeur d'objets de classe PorteET avec nom non-défini
     * 
    ...
    /**
     * Constructeur d'objets de classe PorteET modifiant le nom
     * 
     ...
     * @param (Fil) le fil relié à la sortie
     */
    public PorteET(String s, Fil fentree1,Fil fentree2,Fil fsortie1)
    {
        // invocation du constructeur de la classe parent Circuit
